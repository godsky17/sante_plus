...
@section("auth-content")
            <form class="">
                ...
                <div class="d-flex justify-content-around align-item-center mb-2">
                    <div class="col-6">
                ...
                <div class="text-center">
                    <p>Vous n'avez pas un compte ? <a href="{{ route('inscription') }}">Inscrivez-vous.</a></p>
                    <p>Connectez-vous avec:</p>
                    <div class="row">
                        <ul class="d-flex social-media">
                            <li>
                                <a href="#" class="social-icon">
                                    <svg class="facebook-icon" width="24" height="24" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <path
                            ...
                            <li>
                                <a href="" class="social-icon">
                                    <svg class="apple-icon" width="24" height="24" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <path
