...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="dashboard/img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/id.png') }}"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/us.png') }}"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/au.png') }}"
                                      alt="australia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/ru.png') }}"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/cn.png') }}"
                                      alt="china"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('dashboard/img/flags/br.png') }}"
                                      alt="brazil"
                                    />
                                  </div>
                                </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('dashboard/img/jm_denis.jpg') }}"
                            alt="..."
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('dashboard/img/talha.jpg') }}"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('dashboard/img/chadengle.jpg') }}"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
